...
import com.otherlogic.domain.entity.itemDetails.ItemDetailsInfoDto

data class ItemDetailsInfo(
    ...
    fun toDto():ItemDetailsInfoDto = ItemDetailsInfoDto(
